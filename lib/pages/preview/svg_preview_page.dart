...
import 'svg_preview_document.dart';
...
class _SvgPreviewPageState extends State<SvgPreviewPage> {
  ...
  static const SvgPreviewDocumentFormatter _documentFormatter =
      SvgPreviewDocumentFormatter();
  ...
  String _formatHistoryTime(DateTime value) {
    return _documentFormatter.formatHistoryTime(value);
  }

  String _buildSvgSummary() {
    return _documentFormatter.buildSummary(
      svg: _renderedSvg,
  ...
  String _buildSuggestedFileName(String extension) {
    return _documentFormatter.buildSuggestedFileName(DateTime.now(), extension);
  }
  ...
  Future<File> _createBrowserPreviewFile() async {
    ...
    final htmlContent = _documentFormatter.buildBrowserPreviewHtml(
      _renderedSvg,
    );
