...
abstract class IpaAppInfoParsing {
  Future<IpaAppInfo?> parseFromExtractedDirectory(Directory directory);
}

class IpaAppInfoParser implements IpaAppInfoParsing {
  ...
  Directory? _findAppDirectory(Directory directory) {
    ...
    final appDirectories = payloadDirectory
        ...
        .whereType<Directory>()
        .where(
          (Directory item) => hasFileExtension(item.path, <String>['.app']),
        )
